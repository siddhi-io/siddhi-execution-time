...
public class CurrentTimeFunctionExtensionTestCase {
    ...
    private static final Logger log = LogManager.getLogger(CurrentTimeFunctionExtensionTestCase.class);
        ...
        executionPlanRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents, Event[] removeEvents) {
                ...
                for (Event inEvent : inEvents) {
                    ...
                    log.info("Event : " + eventCount.intValue() + ",currentDate : " + inEvent.getData(1));
